...
public class GetNearestShopInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request,
		...
		logger.info("Entering GetNearestShopInterceptor");
		if(request.getHeader("user") != null && 
				(request.getHeader("user").equalsIgnoreCase("manager")) || request.getHeader("user").equalsIgnoreCase("customer")){
